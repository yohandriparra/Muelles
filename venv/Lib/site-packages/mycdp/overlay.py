...
class SourceOrderConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SourceOrderConfig:
        return cls(
            parent_outline_color=dom.RGBA.from_json(
                json["parentOutlineColor"]
            ),
...
class LineStyle:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LineStyle:
        return cls(
            ...
            pattern=(
                str(json["pattern"])
                if json.get("pattern", None) is not None
                else None
            ),
        )
    ...
    def from_json(cls, json: T_JSON_DICT) -> HighlightConfig:
        return cls(
            ...
            flex_item_highlight_config=(
                FlexItemHighlightConfig.from_json(
                    json["flexItemHighlightConfig"]
                )
            ...
            container_query_container_highlight_config=(
                ...
                if json.get("containerQueryContainerHighlightConfig", None)
                is not None
                else None
            ),
        )
...
class FlexNodeHighlightConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> FlexNodeHighlightConfig:
        return cls(
            flex_container_highlight_config=FlexContainerHighlightConfig.from_json(  # noqa
                json["flexContainerHighlightConfig"]
            ),
            node_id=dom.NodeId.from_json(json["nodeId"]),
        )
...
class ScrollSnapHighlightConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScrollSnapHighlightConfig:
        return cls(
            scroll_snap_container_highlight_config=ScrollSnapContainerHighlightConfig.from_json(  # noqa
                json["scrollSnapContainerHighlightConfig"]
            ),
            node_id=dom.NodeId.from_json(json["nodeId"]),
        )
...
class ContainerQueryHighlightConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ContainerQueryHighlightConfig:
        return cls(
            container_query_container_highlight_config=ContainerQueryContainerHighlightConfig.from_json(  # noqa
                json["containerQueryContainerHighlightConfig"]
            ),
            node_id=dom.NodeId.from_json(json["nodeId"]),
        )
...
class IsolatedElementHighlightConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> IsolatedElementHighlightConfig:
        return cls(
            isolation_mode_highlight_config=IsolationModeHighlightConfig.from_json(  # noqa
                json["isolationModeHighlightConfig"]
            ),
            node_id=dom.NodeId.from_json(json["nodeId"]),
        )
...
def get_highlight_object_for_test(
    ...
    :param show_accessibility_info: *(Optional)*
...
def highlight_quad(
    ...
    :param outline_color: *(Optional)* The highlight outline color
    (default: transparent).
    """
    params: T_JSON_DICT = dict()
...
def highlight_source_order(
    ...
    """
    Highlights the source order of the children of the DOM node
    with given id or with the given JavaScript object wrapper.
    Either nodeId or objectId must be specified.
    :param source_order_config:
...
def set_show_grid_overlays(
    ...
    :param grid_node_highlight_configs:
...
def set_show_flex_overlays(
    ...
    """
    :param flex_node_highlight_configs:
     An array of node identifiers and descriptors for the highlight appearance.
    """
    params: T_JSON_DICT = dict()
...
def set_show_scroll_snap_overlays(
    ...
    """
    :param scroll_snap_highlight_configs:
     An array of node identifiers and descriptors for the highlight appearance.
    """
    params: T_JSON_DICT = dict()
...
def set_show_container_query_overlays(
    container_query_highlight_configs: typing.List[
        ContainerQueryHighlightConfig
    ],
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
    :param container_query_highlight_configs:
     An array of node identifiers and descriptors for the highlight appearance.
    """
    params: T_JSON_DICT = dict()
...
def set_show_isolated_elements(
    isolated_element_highlight_configs: typing.List[
        IsolatedElementHighlightConfig
    ],
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
    Show elements in isolation mode with overlays.
    :param isolated_element_highlight_configs:
    An array of node identifiers and descriptors for the highlight appearance.
    """
    params: T_JSON_DICT = dict()
...
def set_show_window_controls_overlay(
    window_controls_overlay_config: typing.Optional[
        WindowControlsOverlayConfig
    ] = None,
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
    Show Window Controls Overlay for PWA
    :param window_controls_overlay_config: *(Optional)*
     Window Controls Overlay data, null means hide Window Controls Overlay
    """
    params: T_JSON_DICT = dict()
    if window_controls_overlay_config is not None:
        params["windowControlsOverlayConfig"] = (
