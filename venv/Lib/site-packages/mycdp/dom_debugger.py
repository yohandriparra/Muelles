...
def get_event_listeners(
    ...
    :param depth: *(Optional)*
     ...
     or provide an integer larger than 0.
    ...
    Reports listeners for all contexts if pierce is enabled.
...
def set_xhr_breakpoint(
    ...
    :param url: Resource URL substring.
    All XHRs having this substring in the URL will get stopped upon.
    """
    params: T_JSON_DICT = dict()
    params["url"] = url
    cmd_dict: T_JSON_DICT = {
